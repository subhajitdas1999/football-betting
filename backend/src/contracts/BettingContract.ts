const functionsConsumerAbi = [
  ...
  },
  {
    ...
    outputs: [
      ...
      {
        internalType: "uint256",
        name: "weiCollectedForHome",
        type: "uint256",
      },
      {
        internalType: "uint256",
        name: "weiCollectedForAway",
        type: "uint256",
      },
      {
        internalType: "bool",
...
export default functionsConsumerAbi;
